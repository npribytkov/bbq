...
if ($('.price-rage').length){
    $('.price-rage').slider({
        ...
        slide: function( event, ui ) {
            $('.val-input .from').val(ui.values[ 0 ]);
            $('.val-input .to').val(ui.values[ 1 ]);
        }
    });
    $('.val .from').html($( ".price-rage" ).slider( "values", 0 ));
    $('.val .to').html($( ".price-rage" ).slider( "values", 1 ));
    $('.val-input .from').val($( ".price-rage" ).slider( "values", 0 ));
    $('.val-input .to').val($( ".price-rage" ).slider( "values", 1 ));
}